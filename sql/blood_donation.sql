...
values("Jatin","JatinChaudhary0319",87654321);
...
values("Gautam Buddh Nagar, Uttar Pradesh, 201310","bloodresourcemanagementsolution@gmail.com","7894561230");
...
(9,'Are you eligible to donate blood?','eligible','<span style="color: rgb(0, 0, 0); font-family: &quot;Open Sans&quot;, Arial, sans-serif; text-align: justify;">
  <ul>
  <li><b>Age Requirement:</b> Donors must typically be at least 17 or 18 years old, depending on local regulations.</li>
  <li><b>Weight:</b> Donors should weigh a minimum of 110 pounds (50 kilograms).</li>
  <li><b>General Health:</b> Donors should be in good overall health, free from acute illnesses, infections, or chronic conditions that might affect donation safety.</li>
  <li><b>Hemoglobin Level:</b> Donors should have a hemoglobin level within the acceptable range to ensure they have enough red blood cells.</li>
  <li><b>High-Risk Behaviors:</b> Individuals who have engaged in high-risk behaviors related to bloodborne diseases, such as HIV or hepatitis, may be ineligible.</li>
  <li><b>Medications:</b> Some medications may disqualify individuals from donating blood, depending on their impact on blood safety.</li>
  <li><b>Recent Travel:</b> Donors who have recently traveled to areas with certain infectious diseases may be temporarily ineligible.</li>
  </ul>
  <p>These criteria are essential to guarantee the safety of both donors and recipients during the blood donation process. Your eligibility will be assessed by healthcare professionals at the donation site to ensure the safety of the blood supply. Please consult your local blood donation center or organization for specific eligibility guidelines in your region.</p>
</span>');
