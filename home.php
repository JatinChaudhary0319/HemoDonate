  ...
  <ul class="carousel-indicators">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="image\115577711_blood-donation.jpg" alt="blooddonor" width="100%" height="500">
      </div>
      <div class="carousel-item">
        <img src="image\fact.jpg" alt="fact" width="100%" height="500">
      </div>
      <div class="carousel-item">
        <img src="image\blood-donation (1).jpg" alt="donate" width="100%" height="500">
      </div>
...
<br>
        <h1 style="text-align:center;font-size:45px;">Welcome to Blood Resource Management Solution</h1>
<br>
        <div class="row">
...
<br>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="image\donate.jpg" alt="" >
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row mb-4">
            <div class="col-md-12">
            <h4>Are you eligible to donate blood?</h4>
            <p>
              <?php
                include 'conn.php';
                $sql=$sql= "select * from pages where page_type='eligible'";
                $result=mysqli_query($conn,$sql);
                if(mysqli_num_rows($result)>0)   {
                    while($row = mysqli_fetch_assoc($result)) {
                      echo $row['page_data'];
